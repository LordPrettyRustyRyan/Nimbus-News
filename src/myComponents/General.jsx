...
export default function General() {
  ...
  useEffect(() => {
    // Fetch General news from the backend
    axios
      .get('http://localhost:5000/api/news/general')
      .then((res) => {
        setArticles(res.data.articles); // Set the articles to the state
        setLoading(false);
      })
      .catch((err) => {
  ...
  if (loading) return <h2>Loading General News...</h2>;

  return (
    <div>
      <section id="general" className="full-hight px-lg-5">
